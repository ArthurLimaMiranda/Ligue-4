...
public class Tabuleiro implements InterfaceTabuleiro{
	...
	protected String Sound_Ficha = "src/Sounds/cash-register-purchase-87313 (mp3cut.net).mp3";
	protected String Sound_Win = "src/Sounds/bright-notifications-151766 (mp3cut.net).mp3";
